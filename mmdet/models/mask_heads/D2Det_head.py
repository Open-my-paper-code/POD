...
class D2DetHead(nn.Module):
    ...
    def __init__(self,
        ...
        self.D2Det_reg = GConv(self.conv_out_channels, 4, 3, padding=1)
        self.D2Det_mask = GConv(self.conv_out_channels, 1, 3, padding=1)
        ...
        if self.MASK_ON:
            ...
            self.deconv2 = nn.ConvTranspose2d(
                ...
                2,
                stride=2)
            self.D2Det_instance = GConv(256, 81, 3, padding=1)
    ...
    def init_weights(self):
        for m in self.modules():
            if isinstance(m, GConv) or isinstance(m, nn.Linear):
