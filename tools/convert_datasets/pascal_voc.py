...
def parse_args():
    ...
    parser.add_argument('devkit_path', default="/home/ubuntu/bigdisk/DataSets/VOC/VOCdevkit/VOC2007",help='pascal voc devkit path')
    parser.add_argument('-o', '--out-dir', default="/home/ubuntu/bigdisk/DataSets/VOC/VOC_to_COCO/",help='output path')
...
def main():
    # args = parse_args()
    devkit_path = "/home/ubuntu/bigdisk/DataSets/VOC/VOCdevkit"
    # devkit_path = args.devkit_path
    o_dir = "/home/ubuntu/bigdisk/DataSets/VOC/VOC_to_COCO/"
    out_dir = o_dir if o_dir else devkit_path
